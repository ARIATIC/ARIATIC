...
if( $_SERVER['REQUEST_METHOD'] == 'POST' && isset($antispam) && $antispam == '') {
 ...
 if($email != '' && $message != '') {
                ...
                //If you don't receive the email, enable and configure these parameters below: 
                 ...
                 //$mail->Host = 'aspmx.l.google.com';                  // Specify main and backup SMTP servers, example: smtp1.example.com;smtp2.example.com
                 //$mail->SMTPAuth = false;                               // Enable SMTP authentication
                 //$mail->Username = 'info@ariatic.co';                    // SMTP username
